  ...
  <div>
    ...
    <section class="ftco-services ftco-no-pb">
		...
		<section class="ftco-section ftco-no-pt ftc-no-pb">
			<div class="container">
				<div class="row no-gutters">
					<div class="col-md-5 p-md-5 img img-2 mt-5 mt-md-0" :style="{backgroundImage: `url(${require('../assets/images/about.jpg')})`}">
					</div>
		...
		<section class="ftco-intro" :style="{backgroundImage: `url(${require('../assets/images/bg_3.jpg')})`}" data-stellar-background-ratio="0.5">
	          ...
	          <div class="col-md-12 tab-wrap">
	            ...
	            <div class="tab-content bg-light p-4 p-md-5 ftco-animate" id="v-pills-tabContent">
	              ...
	              <div class="tab-pane py-2 fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="day-1-tab">
	              	<div class="row departments">
	              		<div class="col-lg-4 order-lg-last d-flex align-items-stretch">
	              			<div class="img d-flex align-self-stretch" :style="{backgroundImage: `url(${require('../assets/images/dept-1.jpg')})`}"></div>
	              		</div>
	              		<div class="col-lg-8">
	              ...
	              <div class="tab-pane fade" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-day-2-tab">
	              	<div class="row departments">
	              		<div class="col-lg-4 order-lg-last d-flex align-items-stretch">
	              			<div class="img d-flex align-self-stretch" :style="{backgroundImage: `url(${require('../assets/images/dept-2.jpg')})`}"></div>
	              		</div>
	              		<div class="col-md-8">
	              ...
	              <div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-day-3-tab">
	              	<div class="row departments">
	              		<div class="col-lg-4 order-lg-last d-flex align-items-stretch">
	              			<div class="img d-flex align-self-stretch" :style="{backgroundImage: `url(${require('../assets/images/dept-3.jpg')})`}"></div>
	              		</div>
	              		<div class="col-md-8">
	              ...
	              <div class="tab-pane fade" id="v-pills-4" role="tabpanel" aria-labelledby="v-pills-day-4-tab">
	              	<div class="row departments">
	              		<div class="col-lg-4 order-lg-last d-flex align-items-stretch">
	              			<div class="img d-flex align-self-stretch" :style="{backgroundImage: `url(${require('../assets/images/dept-4.jpg')})`}"></div>
	              		</div>
	              		<div class="col-md-8">
	              ...
	              <div class="tab-pane fade" id="v-pills-5" role="tabpanel" aria-labelledby="v-pills-day-5-tab">
	              	<div class="row departments">
	              		<div class="col-lg-4 order-lg-last d-flex align-items-stretch">
	              			<div class="img d-flex align-self-stretch" :style="{backgroundImage: `url(${require('../assets/images/dept-5.jpg')})`}"></div>
	              		</div>
	              		<div class="col-md-8">
